...
export type AboutContents = Record<AboutSectionTitles, AboutSection>;
...
export const aboutContents: AboutContents = {
    ...
    contents: (
      <>
        ...
        <p>
          ...
          of your full retirement across various different retirement start
          dates. The questions we're answering are:
        </p>
        <ul>
          <li>
          ...
          <li>
            How often would I end up with a massive surplus at the end of my
            life?
          </li>
        </ul>
      </>
  ...
  'portfolio-risk-management': {
    depth: 1,
    order: 2,
    text: 'Portfolio Risk Management',
    contents: (
      <>
        <p>
        ...
        <p>
          ...
          famously produced the concept known as the "safe withdrawal rate".
          They used a similar simulation to determine the maximum withdrawal
          rate that avoids most portfolio failures during a 30 year period. This
          produced the "4% rule", which became a useful rule of thumb for
          retirement simulation. So if you had a $1M portfolio, you could safely
          withdrawal 4%, $40,000, annually with minimal risk of portfolio
          failure.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            Adjust your annual withdrawals based on market performance rather
            than continuously withdrawing the same (inflation-adjusted) amount
          </li>
          <li>
            Produce any kind of income throughout retirement to reduce
            withdrawals or even continue depositing
          </li>
        </ul>
        <p>
          A healthy portfolio is really a combination of the portfolio itself
          and the withdrawal strategy.
        </p>
      </>
    )
  },
  'what-about-inflation': {
    ...
    contents: (
      <>
        ...
        <p>
          There are several ways to track inflation. FI Portfolio Doctor
          measures it by tracking the{' '}
          ...
          transportation, etc. The magnitude of change in the average cost of
          this basket measures inflation.
        </p>
        <p>
          We can illustrate the importance of inflation-adjustment with an
          example. If you had started retirement in 1942 and your money grew to
          a nominal value of $328,974,040 by 2001, your inflation-adjusted value
    ...
    contents: (
      <>
        ...
        <p>
          ...
          among less correlated asset classes (emerging markets, etc), your
          actual portfolio may well do better than those based strictly on US
          data, at least in terms of volatility.
        </p>
      </>
    )
  },
  'how-to-use': {
    ...
    contents: (
      <>
        <p>
          I designed FI Portfolio doctor as a way to iterate on various
          scenarious quickly, and to view the details of each run interactively
          with details.
        </p>
        <p>
  ...
  'stock-ratio': {
    ...
    contents: (
      <>
        <p>
          The stock ratio is the amount of stocks versus bonds in your
          portfolio.
        </p>
      </>
    )
    ...
    contents: (
      <>
        <p>
          ...
          invest. If you're using mutual funds, it may be as high as 1%. If
          you're using straight{' '}
  ...
  'simulation-length': {
    ...
    contents: (
      <>
        <p>
          Adjust this number for the planned length of your retirement. The
          longer the retirement length, the fewer cycles we can run against the
          available historical data. If you're an early retiree, this number
          might be something like 60 years, which allows for 90 different
          simulated cycles of retirement (as of 2021).
        </p>
      </>
    )
  },
  withdrawals: {
    ...
    contents: (
      <>
        <p>
          Other than your starting balance, your withdrawal strategy can make
          the biggest impact on your portfolio's health, and there are many
          strategies.
        </p>
        <p>
        ...
        <p>
          ...
          most with this method - as your portfolio grows, so does your
          spending. However, if you have no way to support very low spend years,
          this method isn't as practical.
        </p>
        <p>
          <b className="text-base font-bold">Clamped Percent of Portfolio -</b>{' '}
          My favorite plan for retirement spending is a hybrid of the above two
          rules, a{' '}
          ...
          falls on the scale. This way, you don't have to worry about
          withdrawals below your minimum projected expenses, but you can also
          spend more on good years than you would with a fixed strategy. This
          reduces the odds of failure as well as reducing the odds of having an
          enormous nest egg late in your life.
        </p>
        <p>
          If you're not happy with your portfolio health, try tinkering with
          your minimum spend to get a feel for how much spending flexibility can
          help. Even small reductions in the minimum can cause dramatic
          improvements. See the difference a{' '}
          <TextLink
  ...
  'withdrawal-delays-and-deposits': {
    depth: 2,
    order: 10,
    text: 'Withdrawal Delays and Deposits',
    contents: (
      <>
        <p>
        ...
        <p>
          Additionally, you can account for deposits you know you'll be making
          the future. Perhaps you're expecting to collect Social Security 10
          years into your retirement, or perhaps you know you'll have some
    ...
    contents: (
      <>
        ...
        <p>
          ...
          you'll see detailed lines in the graph which show each simulated
          cycle's portfolio ending balance based on your inputs. Hover and click
          around on the graph to view the details of each cycle and year.
        </p>
        <p>
          ...
          events during each period. If you're interested in a cycle starting on
          a particular year (say, right before the great depression), you can
          select it in the blank table (while no other cycle is selected).
        </p>
        <p>
          <b className="text-base font-bold">Zoom Cycle View -</b> Some of the
          lower and median balance cycles are a bit dwarfed by the cycles that
          did exceedingly well (hurray for compounding interest! 💸) so it is
          hard to see the minutia. To remedy this, select he cycle you want to
          drill down to and select the "Zoom Cycle" view.
        </p>
        <p>
          <b className="text-base font-bold">Quantiles View -</b> This view will
          give you a bird's eye view of each portfolio's performance that's a
          bit cleaner, but less detailed than the all cycles view. 80% of cycles
          lie between the top and bottom lines (90th and 10th percentiles). The
          middle line is the "median" case (50th percentile).
        </p>
        <p>
          <b className="text-base font-bold">Portfolio Health -</b> This is
          ultimately the most important section, the health of your portfolio,
          as diagnosed by FI Portfolio Doctor 👨‍⚕️! If the large majority of the
        ...
        <p>
          ...
          (inflation-adjusted ending balance less than half the original
          balance) and high ending balances (inflation-adjusted ending balance
          more than 3 times the original balance). If enough of your balances
          end precariously low, you may want to consider tweaking your inputs to
          be a bit safer. Likewise, if you have many very high ending balances
          and you'd rather use your money during your lifespan, you can consider
          being more liberal with your spending.
        </p>
      </>
    )
  },
    ...
    contents: (
      <>
        ...
        <p>
          ...
          input parameters. You can either share this with anyone else to show
          off your portfolio run, or you can save the link or bookmark it for
          future reference and rerun it any time by clicking the link or pasting
          it into the browser.
        </p>
        <p>
          If you want to see the details behind the cycles and calculations made
          in the simulation, you can click download, which returns a CSV file
  ...
  disclaimer: {
    ...
    contents: (
      <>
        <p>
          Using historical data to model future returns means we are assuming
          that the future performance will look at least somewhat like the past.
          There are no guarentees that will be the case, so plan accordingly.
          Use this calculator to get a general idea of what a retirement may
          look like and not as financial advice.
        </p>
      </>
    )
  }
...
export default function About() {
  function tableOfContents() {
    return Object.keys(aboutContents)
      .map(
        (key) =>
          ({ key, contents: aboutContents[key] } as {
            key: string;
            contents: AboutSection;
          })
      )
      .sort((a, b) => a.contents.order - b.contents.order)
      .map((t) => {
        const { key, contents } = t;
        const depthClass = contents.depth > 1 ? `ml-${2 * contents.depth}` : '';
        return (
          <a
            key={contents.text}
            href={`${baseUrl}/about#${key}`}
            className={clsx(
              depthClass,
    ...
    return Object.keys(aboutContents)
      ...
      .map((t) => {
        ...
        return (
          <>
            {contents.depth === 1 ? (
              <h2 id={key}>{contents.text}</h2>
            ) : (
              <h3 id={key} className="text-lg font-semibold mb-2">
                {contents.text}
              </h3>
            )}
            {contents.contents}
